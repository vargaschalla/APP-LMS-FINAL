        ...
        <table class="table table-hover">
          <thead>
            <tr>
              ...
              <th scope="col">Plan Académico</th>
...
export default {
  ...
  methods: {
    edit: function (id) {
      this.$router.push("/inscripcion/form/" + id);
    },
    add: function () {
      this.$router.push("/inscripcion/form");
    },
    getList: function () {
      client
        .get("/v1/inscripcion")
    ...
    delete: function (id) {
      client
        .delete(`/v1/inscripcion/${id}`)
        .then(() => {
          this.getList();
          this.message = "Inscripcion removed!";

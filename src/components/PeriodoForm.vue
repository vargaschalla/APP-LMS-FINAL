    ...
    <div class="row">
      <div class="col-sm-10">
        ...
        <b-form @submit="onSubmit" @reset="onReset" class="w-100">
          <b-form-group label-cols="4" label-cols-lg="3" label-size="sm" label="Periodo">
            <b-form-input id="input-sm" size="sm" placeholder="Enter Periodo" type="text" v-model="d.nombre" required></b-form-input>
          </b-form-group>
...
export default {
  ...
  methods: {
    ...
    create: function (payload) {
      client
        .post("/v1/periodo", payload)
        .then(() => {
          console.log(payload);

          this.message = "Periodo added!";
          this.showMessage = true;
          this.$router.push("/periodo?msg="+this.message);
        })
        .catch((error) => {
          this.message = error;
          this.showMessage = true;
    ...
    update: function (payload, id) {
      client
        .put(`/v1/periodo/${id}`, payload)
        .then(() => {
          console.log(payload);

          this.message = "Periodo updated!";
          this.showMessage = true;
          this.$router.push("/periodo?msg="+this.message);
        })
        .catch((error) => {

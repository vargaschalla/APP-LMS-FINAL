...
export default {
  ...
  methods: {
    ...
    create: function (payload) {
      client
        .post("/v1/estudiante", payload)
        .then(() => {
          console.log(payload);

          this.message = "Estudiante added!";
          this.showMessage = true;
          this.$router.push("/estudiante?msg="+this.message);
        })
        .catch((error) => {
          this.message = error;
          this.showMessage = true;
    ...
    update: function (payload, id) {
      client
        .put(`/v1/estudiante/${id}`, payload)
        .then(() => {
          console.log(payload);

          this.message = "Estudiante updated!";
          this.showMessage = true;
          this.$router.push("/estudiante?msg="+this.message);
        })
        .catch((error) => {
